...
export const showDeviceDialogAction = (mode = KodtrolDialogType.ADD, value = null, local = false) => {
  return {
...
export const showScriptDialogAction = (mode = KodtrolDialogType.ADD, value = null, local = false) => {
  return {
...
export const showMediaDialogAction = (mode = KodtrolDialogType.ADD, value = null, local = false) => {
  return {
...
export const showTimelineDialogAction = (mode = KodtrolDialogType.ADD, value = null, local = false) => {
  return {
...
export const showBoardDialogAction = (mode = KodtrolDialogType.ADD, value = null, local = false) => {
  return {
...
export const showConfigDialogAction = (mode = KodtrolDialogType.EDIT, value = null, local = false) => {
  return {
...
export const showImportDialogAction = (mode = KodtrolDialogType.IMPORT_ALL, value = null, local = false) => {
  return {
